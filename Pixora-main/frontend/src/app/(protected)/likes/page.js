  ...
  return (
    <div className="p-2 sm:p-6 w-full max-w-full overflow-hidden">
      <div className="mb-3 sm:mb-6">
        ...
        <p className="text-gray-400 text-sm sm:text-base">Browse all the images you&apos;ve liked across the platform</p>
      </div>
      ...
      {loading ? (
        ...
        >
          <HeartOff className="w-12 h-12 sm:w-16 sm:h-16 text-gray-400 mb-3 sm:mb-4" />
          <p className="text-gray-400 text-base sm:text-lg mb-1 sm:mb-2 text-center px-4">No liked images found</p>
          <p className="text-gray-500 mb-4 sm:mb-6 text-sm sm:text-base text-center px-4">You haven&apos;t liked any images in this category yet</p>
          <Link href="/feed">
